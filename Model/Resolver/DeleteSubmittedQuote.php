...
/**
 * Class DeleteSubmittedQuote
 * @package Mageplaza\RequestForQuoteGraphQl\Model\Resolver
 */
class DeleteSubmittedQuote implements ResolverInterface
{
    ...
    /**
     * DeleteSubmittedQuote constructor.
     *
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        try {
            return $this->quoteRepository->deleteSubmittedQuote($currentUserId, $args['quote_id']);
        } catch (Exception $e) {
