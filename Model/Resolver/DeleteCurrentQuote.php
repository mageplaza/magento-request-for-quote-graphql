...
/**
 * Class DeleteCurrentQuote
 * @package Mageplaza\RequestForQuoteGraphQl\Model\Resolver
 */
class DeleteCurrentQuote implements ResolverInterface
{
    ...
    /**
     * DeleteCurrentQuote constructor.
     *
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        try {
            return $this->quoteRepository->deleteCurrentQuote($currentUserId);
        } catch (Exception $e) {
